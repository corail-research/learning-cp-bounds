...
print('start')
## Train the models
graphs_training = load_dataset('/home/darius/scratch/learning-bounds/data/ssp/train/ssp-data-testset10-80.txt')
...
model.load_state_dict(torch.load('GNN-SSP-10-80.pt'))
...
with open("bounds_learning-ssp-10-80.txt", "w") as file:
    file.write(json.dumps(bounds_learning))

with open("bounds_learning_grad-ssp-10-80.txt", "w") as file:
    file.write(json.dumps(bounds_learning_grad))

with open("bounds_grad-ssp-10-80.txt", "w") as file:
